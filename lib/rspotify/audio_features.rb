module RSpotify
  ...
  # @attr [Integer] key               The key the track is in. Integers map to pitches using standard {https://en.wikipedia.org/wiki/Pitch_class Pitch Class notation}. E.g. 0 = C, 1 = C#/Db, 2 = D, and so on.
